...
/**
 * Created by Ayush on 12/27/2017.
 */
...
public class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    public EventsAdapter(Context mContext, List<Events> albumList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        Events album = albumList.get(position);
        holder.title.setText(album.getName());
        holder.count.setText(album.getNumOfEvents() + " songs");
