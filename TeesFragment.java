...
public class TeesFragment extends Fragment implements TeesAdapter.onItemClickListener{
    ...
    public void onStart() {
        ...
        dialog_msg=getView().findViewById(R.id.message_dailog);
    ...
    private void get_data(final int id) {
        ...
        @SuppressLint("StaticFieldLeak") AsyncTask<Integer,Void,Void> task = new AsyncTask<Integer, Void, Void>() {
            ...
            protected Void doInBackground(Integer... integers) {
                ...
                Request request= new Request.Builder().url(server.server_ip()+"AppAllTees.php?id="+id).build();
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                if (data_list.size() == 0)
                {
                    dialog_msg.setText("COMING SOON");
                }
                else{
                    dialog_msg.setText("Update App to Register");
                }
            }
        };
